      ...
      builder: (context, ref, _) {
        ...
        Future<void> _onPressedFunction() async {
          ...
          await _auth.resetPassword(_email.text,
              context).whenComplete(() => _auth.authStateChange.listen( (event) async{
            if (event == null) {
              loading();
              return;
            }
          ...
          body: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                TextFormFieldWidget(hintText: "Email Address", textInputType: TextInputType.emailAddress,controller: _email, ),
                const SizedBox(height: 10),
                Align(
                  ...
                  child: Container(
                    ...
                    child: ElevatedButton(onPressed:_onPressedFunction,

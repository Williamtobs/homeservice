                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children:[
                          ...
                          const SizedBox(height: 5),
                          const TextFormFieldWidget(hintText: "First Name", textInputType: TextInputType.text, ),
                          const SizedBox(height: 5),
                          const TextFormFieldWidget(hintText: "Last Name", textInputType: TextInputType.text, ),
                          const SizedBox(height: 5),
                          ...
                          const SizedBox(height: 5),
                          const TextFormFieldWidget(hintText: "Your phone number", textInputType: TextInputType.text, ),
                          const SizedBox(height: 5),
                          ...
                          const TextFormFieldWidget(hintText: "Your Email Address", textInputType: TextInputType.emailAddress, ),
                          const SizedBox(height: 5),
